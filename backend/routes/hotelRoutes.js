...
// Upload routes
router.post('/upload', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), upload.array('images', 10), uploadImages);
router.post('/upload-base64', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), uploadImagesBase64);
router.post('/delete-image', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), deleteImage);
router.post('/location/address', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), getAddressFromCoordinates);
router.get('/location/search', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), searchLocation);
router.get('/location/distance', protect, authorizedRoles('partner', 'admin', 'superadmin', 'user', 'owner', 'broker'), calculateDistance);
