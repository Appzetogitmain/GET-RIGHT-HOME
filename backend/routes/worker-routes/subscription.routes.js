...
// Stub payment handlers (to be implemented when Razorpay is configured)
const createSubscriptionOrder = async (req, res) => res.status(501).json({ success: false, message: 'Payment not configured yet' });
const verifySubscriptionPayment = async (req, res) => res.status(501).json({ success: false, message: 'Payment not configured yet' });
