  ...
  const renderField = (field) => {
    ...
    switch (field.type) {
      ...
      case 'repeater':
        ...
        return (
          <div key={field.name} id={`field-${field.name}`} className="mb-6 p-5 bg-slate-50 border border-slate-200 rounded-2xl">
            ...
            {errors[field.name] && <p className="text-red-500 text-xs mt-2">{errors[field.name]}</p>}
          </div>
        );
