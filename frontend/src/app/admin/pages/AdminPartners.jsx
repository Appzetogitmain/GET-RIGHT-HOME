                                ...
                                <AnimatePresence>
                                    {users.length > 0 ? (
                                        users.map((user, index) => (
                                            ...
                                            >
                                                <td className="p-4">
                                                    <Link to={`${basePath}/partners/${user._id}`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                                                ...
                                                <td className="p-4 text-center relative">
                                                    ...
                                                    {activeDropdown === user._id && (
                                                        <div className="absolute right-8 top-8 w-40 bg-white border border-gray-200 rounded-lg shadow-xl z-20 py-1 text-left">
                                                            <Link to={`${basePath}/partners/${user._id}`} className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50 text-[10px] font-bold uppercase text-gray-700">
