  ...
  if (!raw) {
    return {
      ...
      home: {
        ...
        isVipEnabled: true,
        vipPrice: 199,
        vipOriginalPrice: 599,
        vipDurationText: "6 months",
        vipDurationDays: 56,
        ...
        isCategorySectionsVisible: true,
  ...
  try {
    ...
    return {
      ...
      home: parsed?.home && typeof parsed.home === "object" ? {
        ...
        promoCarousel: parsed.home.promoCarousel || [],
        curatedServices: parsed.home.curatedServices || [],
        newAndNoteworthy: parsed.home.newAndNoteworthy || [],
        mostBooked: parsed.home.mostBooked || [],
        categorySections: parsed.home.categorySections || [],
        ...
        isBannersVisible: parsed.home.isBannersVisible ?? true,
        isPromosVisible: parsed.home.isPromosVisible ?? true,
        isCuratedVisible: parsed.home.isCuratedVisible ?? true,
        isNoteworthyVisible: parsed.home.isNoteworthyVisible ?? true,
        isBookedVisible: parsed.home.isBookedVisible ?? true,
        isCategorySectionsVisible: parsed.home.isCategorySectionsVisible ?? true,
        isCategoriesVisible: parsed.home.isCategoriesVisible ?? true,
        isReviewsVisible: parsed.home.isReviewsVisible ?? true,
        isFaqsVisible: parsed.home.isFaqsVisible ?? true
      } : defaultHome,
